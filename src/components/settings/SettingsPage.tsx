  ...
  return (
    <section className="mx-auto max-w-3xl py-12 px-6 animate-in fade-in duration-700">
      ...
      <div className="mb-16">
        ...
        <p className="mt-2 text-base text-text-muted">Manage your device preferences and network configuration.</p>
      </div>

      {loading && <p className="text-text-muted animate-pulse">Loading your preferences...</p>}
      {error && <p className="rounded-xl bg-error/10 p-4 text-sm text-error border border-error/20 mb-8">{error}</p>}
