...
SwiftShare is a cross-platform desktop application for fast local Wi-Fi file sharing built with React, TypeScript, Tauri v2, and Rust. It enables users to send/receive files, folders, images, text, and manage transfer history without internet connectivity.
...
2. Discovery continuously listens for other SwiftShare devices
...
- mDNS service type: `_swiftshare._tcp.local.`
